  ...
  return (
    <>
      ...
      <div className="container">
        ...
        {/* ==================== MODULE QUIZ ==================== */}
        <Quiz
          title="Module 2.2 Quiz: Semantics and Semantic Structures"
          questions={[
            { question: "What is the main concern of semantics in linguistics?", options: ["Sound production mechanisms", "Sentence formation rules", "Meaning and interpretation of linguistic expressions", "Language variation across communities"], correctAnswer: 2, explanation: "Semantics is the branch of linguistics concerned with the study of meaning — how words, phrases, and sentences convey meaning." },
            { question: "Which semantic relation exists between 'dog' and 'animal'?", options: ["Synonymy", "Antonymy", "Hyponymy", "Meronymy"], correctAnswer: 2, explanation: "Hyponymy is a type-of relationship: 'dog' is a type of 'animal', making 'dog' a hyponym and 'animal' the hypernym." },
            { question: "What does the compositionality principle state?", options: ["Meaning of whole is derived from parts", "Meaning comes from context only", "Words have fixed meanings", "Grammar determines meaning entirely"], correctAnswer: 0, explanation: "The principle of compositionality states that the meaning of a complex expression is determined by the meanings of its parts and their combination." },
            { question: "What are synonyms?", options: ["Words with opposite meanings", "Words with similar meanings", "Words that sound the same", "Words from the same category"], correctAnswer: 1, explanation: "Synonyms are words that have the same or very similar meanings, such as 'big' and 'large'." },
            { question: "What is polysemy?", options: ["Multiple words, one meaning", "One word, multiple related meanings", "Words that sound identical", "Words with no meaning"], correctAnswer: 1, explanation: "Polysemy is when a single word has multiple related meanings, like 'head' meaning body part, leader, or top of a list." }
          ]}
          subject="LS"
          unitId={2}
          moduleId={2}
