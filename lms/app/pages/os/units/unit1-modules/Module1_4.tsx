  ...
  return (
    <div className="module-content">
      ...
      <section className="content-section">
        ...
        <img src="https://media.tenor.com/Wy0aK-SkjmcAAAAi/start-begin.gif" alt="Start Animation" className="lesson-image" style={{ width: 200, display: 'block', margin: '20px auto' }} />
        ...
        <img src="https://kq-storage.s3.ap-south-1.amazonaws.com/Operating%2BSystems/system-call-steps-execution.webp" alt="System Call Steps" className="lesson-image" style={{ display: 'block', margin: '32px auto', borderRadius: 12 }} />
        ...
        <img src="https://kq-storage.s3.ap-south-1.amazonaws.com/Operating+Systems/OS-system-calls.png" alt="OS System Calls" className="lesson-image" style={{ display: 'block', margin: '32px auto', borderRadius: 12 }} />
        ...
        <img src="https://kq-storage.kalvium.community/system%20calls.jpg" alt="Features of System Calls" className="lesson-image" style={{ display: 'block', margin: '32px auto', borderRadius: 12 }} />
        ...
        <img src="https://kq-storage.s3.ap-south-1.amazonaws.com/Operating+Systems/OS-system-calls-process-flow.png" alt="Process Control Flow" className="lesson-image" style={{ display: 'block', margin: '32px auto', borderRadius: 12 }} />
        ...
        <img src="https://kq-storage.s3.ap-south-1.amazonaws.com/Operating+Systems/OS-system-calls-file-sys.png" alt="File System Diagram" className="lesson-image" style={{ display: 'block', margin: '32px auto', borderRadius: 12 }} />
        ...
        <img src="https://kq-storage.s3.ap-south-1.amazonaws.com/Operating+Systems/OS-chromecast.png" alt="Chromecast Communication" className="lesson-image" style={{ display: 'block', margin: '32px auto', borderRadius: 12 }} />
        ...
        <img src="https://kq-storage.s3.ap-south-1.amazonaws.com/Operating%2BSystems/System+calls+and+programs.svg" alt="System Calls and Programs Mind Map" className="lesson-image" style={{ display: 'block', margin: '32px auto', maxWidth: '100%' }} />
        ...
        <img src="https://kq-storage.s3.ap-south-1.amazonaws.com/Operating+Systems/os_system_calls_gif.gif" alt="System Calls Animation" className="lesson-image" style={{ display: 'block', margin: '32px auto' }} />

        <p>Now, let's progress to the next lesson!</p>

        <Quiz
          title="Module 1.4 Quiz: System Calls and Programs"
          questions={[
            {
              question: "What is a system call?",
              options: ["A way to call a friend using a computer", "A request made by a program to the OS kernel for a specific service", "A hardware component in the CPU", "A programming language"],
              correctAnswer: 1,
              explanation: "System calls are the interface between a running program and the operating system kernel."
            },
            {
              question: "Which mode must the processor be in to execute a system call?",
              options: ["User Mode", "Safe Mode", "Kernel Mode", "Developer Mode"],
              correctAnswer: 2,
              explanation: "System calls provide a transition from user mode to kernel mode to perform privileged operations securely."
            },
            {
              question: "Which type of system call is used to establish a network connection in a streaming app like Netflix?",
              options: ["Process Control", "File Manipulation", "Communications", "Information Maintenance"],
              correctAnswer: 2,
              explanation: "Communications system calls handle data exchange between processes or across networks."
            },
            {
              question: "What is the role of an API (Application Program Interface) in system calls?",
              options: ["To slow down the system", "To hide the complexity of system calls from the programmer", "To manage the physical hardware", "To delete files automatically"],
              correctAnswer: 1,
              explanation: "APIs provide high-level functions that programmers can use to invoke system calls without needing to know low-level details."
            },
            {
              question: "Which of the following is an example of a system program?",
              options: ["A video game", "A compiler like gcc", "A web browser", "A spreadsheet application"],
              correctAnswer: 1,
              explanation: "System programs are utilities provided by the OS to help with program development and execution (compilers, debuggers) and system management (file explorers, task managers)."
            }
          ]}
          subject="OS"
          unitId={1}
