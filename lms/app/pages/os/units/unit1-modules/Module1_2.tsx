  ...
  return (
    <div className="module-content">
      ...
      <section className="content-section">
        ...
        <img src="https://kq-storage.s3.ap-south-1.amazonaws.com/Operating+Systems/os_intro_cover.jpg" alt="OS Overview" className="lesson-image" style={{ display: 'block', margin: '32px auto', borderRadius: 12 }} />
        ...
        <ul>
          <li>The OS provides services to manage network connections.</li>
          <li>Handles communication between computers, data transmission, and network security.</li>
        ...
        <img src="https://kq-storage.s3.ap-south-1.amazonaws.com/Operating%2BSystems/Introduction+to+Operating+System.svg" alt="Introduction to Operating System Mind Map" style={{ display: 'block', margin: '32px auto', maxWidth: '100%' }} />

        <p>Let's move on to the next lesson!</p>

        <Quiz
          title="Module 1.2 Quiz: Introduction to OS"
          questions={[
            {
              question: "What is an Operating System?",
              options: ["A hardware component", "A special type of software that acts as a bridge between user and hardware", "A program for editing photos", "A virus protection tool"],
              correctAnswer: 1,
              explanation: "An OS is system software that manages hardware resources and provides an interface for users and applications."
            },
            {
              question: "Which type of OS ensures an immediate response to input events and is used in robotics?",
              options: ["Batch OS", "Distributed OS", "Real-Time OS (RTOS)", "Mobile OS"],
              correctAnswer: 2,
              explanation: "RTOS is designed for applications where timing is critical, such as robotics, medical devices, and aviation."
            },
            {
              question: "What is the main advantage of a Graphical User Interface (GUI) over a Command-Line Interface (CLI)?",
              options: ["It uses fewer resources", "It provides more precise control", "It is intuitive and user-friendly for general users", "It is faster for automation"],
              correctAnswer: 2,
              explanation: "GUIs use visual elements like icons and buttons, making them accessible to non-technical users, whereas CLI requires text commands."
            },
            {
              question: "Which OS service is responsible for allocating memory to processes?",
              options: ["Process Management", "Memory Management", "File Management", "Device Management"],
              correctAnswer: 1,
              explanation: "Memory management handles the allocation and deallocation of main memory to ensure processes run efficiently."
            },
            {
              question: "What does 'Multitasking' allow an OS to do?",
              options: ["Run only one program at a time", "Rapidly switch between multiple tasks to appear as if they run simultaneously", "Delete files automatically", "Turn off the computer when idle"],
              correctAnswer: 1,
              explanation: "Multitasking is the ability of an OS to switch quickly between different tasks, such as listening to music while typing a document."
            }
          ]}
          subject="OS"
          unitId={1}
