...
const semaphoreQuiz = [
  {
    question: "Which operation is used to 'wait' on a semaphore and decrement its value?",
    options: ["signal()", "wait() (or P())", "exit()", "post()"],
    correctAnswer: 1,
    explanation: "The wait() or P() operation attempts to acquire a resource by decrementing the semaphore's count."
  },
  {
    question: "A semaphore initialized to 5 performs 3 wait() operations and 2 signal() operations. What is the final value?",
    options: ["0", "3", "4", "6"],
    correctAnswer: 2,
    explanation: "Final = Initial - P + V = 5 - 3 + 2 = 4."
  },
  {
    question: "What is the primary difference between a binary semaphore and a counting semaphore?",
    options: ["Binary semaphores are for software only.", "Binary semaphores take only 0 or 1, while counting semaphores can be any non-negative integer.", "Counting semaphores are used for hardware interrupts.", "There is no difference; the terms are synonymous."],
    correctAnswer: 1,
    explanation: "Binary semaphores act as locks (on/off), while counting semaphores manage multiple instances of a resource (like seats in a theater)."
  },
  {
    question: "Why is 'busy waiting' undesirable in semaphore implementations?",
    options: ["It uses too much memory.", "It prevents processes from finishing.", "It wastes CPU time by keeping a process in a loop checking the same variable.", "It is a hardware requirement."],
    correctAnswer: 2,
    explanation: "Busy waiting (spinlock) keeps the CPU active doing nothing useful; modern OS put waiting processes in a 'blocked' queue instead."
  },
  {
    question: "Which operation is performed when a process releases a resource and increments the semaphore?",
    options: ["P Operation", "Wait Operation", "V Operation (or Signal)", "Drop Operation"],
    correctAnswer: 2,
    explanation: "The Signal or V operation increments the counter and potentially wakes up one of the processes blocked on that semaphore."
  }
];
  ...
  return (
    <div className="module-content">
      ...
      <section className="content-section">
        ...
        <Quiz
          title="Module 3.4 Quiz: Semaphores"
          questions={semaphoreQuiz}
          subject="OS"
          unitId={3}
          moduleId={4}
        />
