...
const monitorQuiz = [
  {
    question: "What is a major advantage of Monitors over Semaphores?",
    options: ["They are faster in all situations.", "They provide automatic mutual exclusion, reducing the chance of programming errors.", "They do not use memory.", "They are a hardware-only solution."],
    correctAnswer: 1,
    explanation: "Unlike semaphores where the programmer must remember to signal/wait correctly, monitors handle mutual exclusion automatically for all procedures inside them."
  },
  {
    question: "Which of the following describes a 'Condition Variable' in a monitor?",
    options: ["A variable that stores the CPU temperature.", "An integer counter similar to a semaphore.", "A mechanism to allow a process to wait for a specific condition or signal others when that condition is met.", "A flag that tells the monitor to shut down."],
    correctAnswer: 2,
    explanation: "Condition variables provide a structured way for processes to sleep (wait) and wake up (signal) based on high-level program logic."
  },
  {
    question: "In the context of monitors, what does the wait(x) operation do?",
    options: ["It pauses the entire OS.", "It suspends the calling process and adds it to a queue associated with condition x.", "It deletes the shared data x.", "It signals all other processes to start running."],
    correctAnswer: 1,
    explanation: "Wait(x) allows a process to 'step aside' and give up its turn in the monitor until the specific resource or condition x becomes available."
  },
  {
    question: "How does a monitor solve the Dining Philosophers problem without deadlock?",
    options: ["By letting everyone eat at once.", "By ensuring a philosopher only sits down if they are not hungry.", "By allowing a philosopher to eat only when both chopsticks are free and ensuring mutual exclusion for state changes.", "By using a random timer for everyone."],
    correctAnswer: 2,
    explanation: "The monitor coordinates the philosophers' states (Thinking, Hungry, Eating) and ensures that pickup/putdown operations are handled safely and atomically."
  },
  {
    question: "Does a Monitor require explicit manual locking and unlocking of shared variables by the programmer for every use?",
    options: ["Yes, just like semaphores.", "No, it provides automatic mutual exclusion for all encapsulated procedures.", "Only if the monitor is large.", "Only when used with condition variables."],
    correctAnswer: 1,
    explanation: "One of the key benefits of monitors is that the language/compiler handles the locking/unlocking 'wrapper' around the monitor's code automatically."
  }
];
  ...
  return (
    <div className="module-content">
      ...
      <section className="content-section">
        ...
        <Quiz
          title="Module 3.6 Quiz: Monitors"
          questions={monitorQuiz}
          subject="OS"
          unitId={3}
          moduleId={6}
        />
