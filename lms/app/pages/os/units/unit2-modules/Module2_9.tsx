...
const Module2_9: React.FC = () => {
  const priorityQuiz = [
    {
      question: "In Priority Scheduling, if two processes have the same priority level, which secondary method is usually used to decide the winner?",
      options: ["Shortest Job First", "First Come First Served (FCFS)", "Last In First Out (LIFO)", "Random Selection"],
      correctAnswer: 1,
      explanation: "When priorities are equal, the scheduler typically defaults to FCFS based on arrival time."
    },
    {
      question: "What is the phenomenon where a low-priority process stays in the ready queue indefinitely because higher-priority processes keep arriving?",
      options: ["Aging", "Starvation", "Context Switching", "Priority Inversion"],
      correctAnswer: 1,
      explanation: "Starvation (or indefinite blocking) is a major risk in priority scheduling systems."
    },
    {
      question: "Which technique is used to solve the problem of starvation by gradually increasing the priority of long-waiting processes?",
      options: ["Scaling", "Aging", "Preemption", "Quantum Leaping"],
      correctAnswer: 1,
      explanation: "Aging ensures that even the lowest-priority process eventually becomes a high-priority process as it spends more time in the queue."
    },
    {
      question: "In a priority system where lower numbers represent higher priority, which process runs first: P1 (priority 5) or P2 (priority 2)?",
      options: ["P1", "P2", "They run at the same time.", "It depends on their burst time."],
      correctAnswer: 1,
      explanation: "If smaller numbers equal higher priority, then priority 2 is 'higher' than priority 5."
    },
    {
      question: "Which type of priority scheduling allows a newly arrived high-priority process to take the CPU away from a currently running lower-priority process?",
      options: ["Non-Preemptive", "Preemptive", "Static", "Sequential"],
      correctAnswer: 1,
      explanation: "Preemptive priority scheduling immediately switches the CPU to the highest-priority ready process."
    }
  ];
  return (
    <div className="module-content">
      ...
      <section className="content-section">
        ...
        <Quiz
          title="Module 2.9 Quiz: Priority Scheduling"
          questions={priorityQuiz}
          subject="OS"
          unitId={2}
          moduleId={9}
        />
