...
const Module2_11: React.FC = () => {
  const roundRobinQuiz = [
    {
      question: "Which of the following describes the Round Robin (RR) scheduling algorithm?",
      options: ["A non-preemptive algorithm for batch systems.", "A preemptive algorithm designed specifically for time-sharing systems.", "An algorithm that always picks the longest job first.", "A scheduling technique that uses a LIFO queue."],
      correctAnswer: 1,
      explanation: "Round Robin is a preemptive scheduling algorithm that uses time slices to ensure every process gets a turn in multi-user systems."
    },
    {
      question: "What is the 'Time Quantum' in Round Robin scheduling?",
      options: ["The total time the system stays powered on.", "A small, fixed unit of time allocated to each process.", "The time it takes to perform a context switch.", "The number of processes currently in the ready queue."],
      correctAnswer: 1,
      explanation: "A time quantum (or time slice) is the maximum time a process is allowed to run before being preempted by the scheduler."
    },
    {
      question: "What happens if the time quantum in Round Robin is extremely large (larger than any process burst time)?",
      options: ["The system crashes.", "It behaves exactly like First-Come First-Serve (FCFS).", "It becomes more efficient than Shortest Job First.", "It results in high overhead from context switching."],
      correctAnswer: 1,
      explanation: "If the quantum is large enough that every process completes in one slice, preemption never occurs, making it identical to FCFS."
    },
    {
      question: "What is a disadvantage of having a very small time quantum?",
      options: ["Response time increases.", "It causes the convoy effect.", "Increased system overhead due to frequent context switching.", "Starvation for long-running processes."],
      correctAnswer: 2,
      explanation: "A very small time quantum leads to many context switches, which takes up CPU time that could be spent on actual process execution."
    },
    {
      question: "Round Robin is particularly effective at mitigating which of the following?",
      options: ["Deadlocks", "Memory leaks", "The Convoy effect", "Starvation in priority systems"],
      correctAnswer: 2,
      explanation: "By giving every process a chance to run frequently, RR prevents short processes from being stuck for long periods behind a large process (the convoy effect)."
    }
  ];
  return (
    <div className="module-content">
      ...
      <section className="content-section">
        ...
        <Quiz
          title="Module 2.11 Quiz: Round Robin"
          questions={roundRobinQuiz}
          subject="OS"
          unitId={2}
          moduleId={11}
        />
