...
const Module2_5: React.FC = () => {
  const fcfsQuiz = [
    {
      question: "What is the core principle of the First Come First Served (FCFS) scheduling algorithm?",
      options: ["Processes with the shortest burst time execute first.", "Processes execute in the exact order they arrive in the ready queue.", "Processes are interrupted if a higher-priority task arrives.", "The most complex processes get CPU priority."],
      correctAnswer: 1,
      explanation: "FCFS is a non-preemptive algorithm that handles requests in the order they are received."
    },
    {
      question: "Which term describes the inefficiency where short processes must wait for a very long process to finish in FCFS?",
      options: ["Starvation", "Context Switching Error", "Convoy Effect", "Deadlock"],
      correctAnswer: 2,
      explanation: "The convoy effect occurs when smaller processes get stuck behind a single large process, leading to higher average waiting times."
    },
    {
      question: "Is the First Come First Served (FCFS) algorithm usually preemptive or non-preemptive?",
      options: ["Preemptive", "Non-preemptive", "Hybrid", "Iterative"],
      correctAnswer: 1,
      explanation: "FCFS is non-preemptive; once a process starts executing, it continues until it terminates or blocks for I/O."
    },
    {
      question: "How is 'Turnaround Time (TAT)' calculated?",
      options: ["Burst Time + Arrival Time", "Completion Time – Arrival Time", "Waiting Time + Completion Time", "Arrival Time – Completion Time"],
      correctAnswer: 1,
      explanation: "Turnaround Time (TAT) is the total time from process arrival to its completion: Completion Time (CT) – Arrival Time (AT)."
    },
    {
      question: "If Process A arrives at time 0 with burst time 10, and Process B arrives at time 1 with burst time 2, what is Process B's waiting time in FCFS?",
      options: ["0", "1", "9", "12"],
      correctAnswer: 2,
      explanation: "Process A starts at 0 and finishes at 10. Process B arrives at 1 but must wait until A finishes at 10. So B's waiting time = 10 (start time) - 1 (arrival time) = 9."
    }
  ];
  return (
    <div className="module-content">
      ...
      <section className="content-section">
        ...
        <Quiz
          title="Module 2.5 Quiz: FCFS Scheduling"
          questions={fcfsQuiz}
          subject="OS"
          unitId={2}
          moduleId={5}
