...
const Module2_4: React.FC = () => {
  const schedulingQuiz = [
    {
      question: "What is the primary function of the CPU scheduler?",
      options: ["Deciding where to store data on the disk.", "Deciding which process in the ready queue should be executed by the CPU.", "Allocating memory to new processes.", "Managing network connections."],
      correctAnswer: 1,
      explanation: "The CPU scheduler's job is to select from the processes in memory that are ready to execute and allocate the CPU to one of them."
    },
    {
      question: "What happens during an 'I/O burst' in a process cycle?",
      options: ["The CPU performs heavy calculations.", "The process is waiting for an I/O operation to complete.", "The process is being terminated.", "The process is being moved to the ready queue."],
      correctAnswer: 1,
      explanation: "An I/O burst occurs when a process pauses its CPU execution to wait for a read, write, or other input/output task."
    },
    {
      question: "Which type of scheduling allows a running process to be interrupted and moved back to the ready queue?",
      options: ["Non-Preemptive Scheduling", "Preemptive Scheduling", "Sequential Scheduling", "Static Scheduling"],
      correctAnswer: 1,
      explanation: "Preemptive scheduling allows the OS to take the CPU away from a process before it finishes, usually to give it to a higher-priority process."
    },
    {
      question: "What is the role of the 'dispatcher' in the operating system?",
      options: ["Selecting which process runs next.", "Giving control of the CPU to the process selected by the scheduler.", "Generating system calls.", "Managing disk partitions."],
      correctAnswer: 1,
      explanation: "While the scheduler selects a process, the dispatcher is the module that actually gives control of the CPU to that selected process."
    },
    {
      question: "Which scheduling criterion measures the number of processes completed per unit of time?",
      options: ["CPU Utilization", "Throughput", "Turnaround Time", "Waiting Time"],
      correctAnswer: 1,
      explanation: "Throughput specifically refers to the number of processes that the system completes in a given time interval."
    }
  ];
  return (
    <div className="module-content">
      ...
      <section className="content-section">
        ...
        <Quiz
          title="Module 2.4 Quiz: CPU Scheduling"
          questions={schedulingQuiz}
          subject="OS"
          unitId={2}
          moduleId={4}
        />
