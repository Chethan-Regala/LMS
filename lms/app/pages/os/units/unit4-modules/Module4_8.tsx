...
const Module4_8: React.FC = () => {
  const assignmentQuiz = [
    {
      question: "Which of these schemes is based on the logical structure of a program rather than physical block sizes?",
      options: ["Paging", "Fixed Partitioning", "Segmentation", "Dynamic Swapping"],
      correctAnswer: 2,
      explanation: "Segmentation organizes memory into units like 'Main Program', 'Functions', and 'Stack', which is how programmers logically view their code."
    },
    {
      question: "In paging, what is the significance of 'fixed-size' pages and frames?",
      options: ["It makes the program run faster.", "It eliminates external fragmentation because every page fits exactly into any free frame.", "It uses less power.", "It allows for 3D graphics."],
      correctAnswer: 1,
      explanation: "Because any page can fit into any frame, there are no 'awkward sized' gaps left over that can't be used (external fragmentation)."
    },
    {
      question: "What is a 'limit' in the context of a Segment Table?",
      options: ["The maximum speed of the CPU.", "The length or size of the specific segment.", "The number of users allowed in the OS.", "The amount of time a process can run."],
      correctAnswer: 1,
      explanation: "Since segments have variable sizes, the Segment Table must store a 'limit' to ensure a process doesn't try to access memory outside its segment's boundary."
    },
    {
      question: "Internal fragmentation is more common in which of the following?",
      options: ["Segmentation", "Fixed Partitioning", "Paging", "Both B and C"],
      correctAnswer: 3,
      explanation: "Paging (if the last page isn't full) and Fixed Partitioning (if the process is smaller than the block) both suffer from internal fragmentation."
    },
    {
      question: "Which table is used by the OS to keep track of physical memory mapping in Paging?",
      options: ["Logic Table", "Segment Table", "Hash Table", "Page Table"],
      correctAnswer: 3,
      explanation: "The Page Table links logical page numbers to their actual physical frame locations in RAM."
    }
  ];
  return (
    <div className="module-content">
      ...
      <section className="content-section">
        ...
        <Quiz
          title="Module 4.8 Quiz: Paging vs Segmentation"
