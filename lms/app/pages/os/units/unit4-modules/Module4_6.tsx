...
const Module4_6: React.FC = () => {
  const pagingQuiz = [
    {
      question: "What are the fixed-size blocks of physical memory (RAM) called in a paging system?",
      options: ["Pages", "Segments", "Frames", "Blocks"],
      correctAnswer: 2,
      explanation: "In paging, logical memory is divided into 'pages' and physical memory is divided into 'frames'. Both are of the same size."
    },
    {
      question: "What is the primary role of the 'Page Table'?",
      options: ["To store the actual data of the program.", "To map logical page numbers to their corresponding physical frame numbers.", "To speed up the internet connection.", "To delete unused frames from RAM."],
      correctAnswer: 1,
      explanation: "The page table is the directory that tells the CPU exactly where in the physical RAM a specific logical page is currently sitting."
    },
    {
      question: "Under what condition does a 'Page Fault' occur?",
      options: ["When the CPU is too hot.", "When a program tries to access a page that is not currently loaded into physical memory.", "When the page table is too large.", "When the user closes a program."],
      correctAnswer: 1,
      explanation: "A page fault is a trap to the OS indicating that the requested data must be brought in from the disk (backing store) into RAM."
    },
    {
      question: "Which of the following is a major advantage of Paging?",
      options: ["It makes the program run slower.", "It eliminates external fragmentation by allowing processes to be stored non-contiguously.", "It requires no extra memory for tables.", "It only works with small programs."],
      correctAnswer: 1,
      explanation: "Paging allows the OS to use every available frame of RAM, even if they aren't next to each other, so no space is wasted in between allocations."
    },
    {
      question: "In the address translation process, what does the 'Offset' represent?",
      options: ["The specific page number.", "The distance from the start of the page to the specific data being accessed.", "The total number of pages in the system.", "The time taken to load a page."],
      correctAnswer: 1,
      explanation: "The offset is combined with the base address of the frame to find the exact byte or word needed within that frame."
    }
  ];
  return (
    <div className="module-content">
      ...
      <section className="content-section">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="w-full md:w-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-1 gap-2">
                <div className="border-4 border-blue-500 bg-blue-50 px-4 py-2 rounded-xl font-bold text-gray-800 text-center text-sm">Page 0</div>
                <div className="border-4 border-green-500 bg-green-50 px-4 py-2 rounded-xl font-bold text-gray-800 text-center text-sm">Page 1</div>
                <div className="border-4 border-orange-500 bg-orange-50 px-4 py-2 rounded-xl font-bold text-gray-800 text-center text-sm">Page 2</div>
                <div className="border-4 border-purple-500 bg-purple-50 px-4 py-2 rounded-xl font-bold text-gray-800 text-center text-sm">Page 3</div>
              </div>
            </div>
            ...
            <div className="w-full md:w-auto">
              ...
              <div className="space-y-2">
                <div className="border-4 border-purple-500 bg-purple-50 px-4 py-2 rounded-xl font-bold text-gray-800 text-center text-sm">Frame 0: Page 3</div>
                <div className="border-4 border-gray-300 bg-gray-100 px-4 py-2 rounded-xl font-bold text-gray-400 text-center text-sm">Frame 1: Empty</div>
                <div className="border-4 border-blue-500 bg-blue-50 px-4 py-2 rounded-xl font-bold text-gray-800 text-center text-sm">Frame 2: Page 0</div>
                <div className="border-4 border-orange-500 bg-orange-50 px-4 py-2 rounded-xl font-bold text-gray-800 text-center text-sm">Frame 3: Page 2</div>
                <div className="border-4 border-green-500 bg-green-50 px-4 py-2 rounded-xl font-bold text-gray-800 text-center text-sm">Frame 4: Page 1</div>
              </div>
            </div>
          </div>
          <p className="text-center text-sm text-gray-600 mt-6 font-medium">Pages are mapped into available frames in RAM, allowing for non-contiguous storage.</p>
        </div>
        ...
        <Quiz
          title="Module 4.6 Quiz: Paging Fundamentals"
          questions={pagingQuiz}
          subject="OS"
          unitId={4}
          moduleId={6}
        />
