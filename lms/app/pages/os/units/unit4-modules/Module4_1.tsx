...
const Module4_1: React.FC = () => {
  const memoryIntroQuiz = [
    {
      question: "What is the primary objective of Memory Management in an Operating System?",
      options: ["To increase the speed of the internet.", "To coordinate and control computer memory, assigning blocks to running programs.", "To delete old files automatically.", "To manage the hardware temperature."],
      correctAnswer: 1,
      explanation: "Memory Management ensures that processes have enough memory to run, tracks which parts are in use, and optimizes overall system performance."
    },
    {
      question: "Which term describes moving a process temporarily from main memory to secondary storage to free up space?",
      options: ["Caching", "Swapping", "Paging", "Fragmentation"],
      correctAnswer: 1,
      explanation: "Swapping allows the OS to run more processes than can physically fit in RAM by moving inactive ones to a high-speed disk (backing store)."
    },
    {
      question: "In which memory management scheme must a program occupy a single, continuous block of storage locations?",
      options: ["Non-contiguous", "Paging", "Contiguous", "Segmentation"],
      correctAnswer: 2,
      explanation: "Contiguous memory allocation means the entire process must sit in one unbroken sequence of memory addresses."
    },
    {
      question: "What is 'Internal Fragmentation'?",
      options: ["Memory wasted because the allocated partition is slightly larger than the process.", "Memory wasted because the process is larger than the partition.", "A virus that eats RAM.", "The CPU running too slow."],
      correctAnswer: 0,
      explanation: "Internal fragmentation happens in fixed partitioning when a small process is put into a large fixed block, leaving empty space inside that block that no one else can use."
    },
    {
      question: "Which of the following describes 'Paging'?",
      options: ["A contiguous memory scheme.", "Dividing a process into fixed-size blocks (pages) that can be stored anywhere in main memory.", "Dividing a process into logical sections like code and data.", "Deleting pages of error logs."],
      correctAnswer: 1,
      explanation: "Paging is a non-contiguous scheme that allows a process's memory to be scattered across physical RAM frames, eliminating external fragmentation."
    }
  ];
  return (
    <div className="module-content">
      ...
      <section className="content-section">
        ...
        <div className="bg-gray-50 rounded-2xl p-4 md:p-8 my-6">
          <div className="flex flex-wrap items-center justify-center gap-4 md:gap-8">
            <div className="text-center">
              <div className="border-4 border-blue-500 bg-blue-50 px-4 py-2 md:px-6 md:py-3 rounded-2xl font-bold text-gray-800 text-sm md:text-base">Process P1</div>
              <p className="text-xs md:text-sm text-gray-600 mt-2">↓ Swapped Out</p>
            </div>
            <div className="border-4 border-gray-500 bg-gray-100 px-4 py-2 md:px-6 md:py-3 rounded-2xl font-bold text-gray-800 text-sm md:text-base">Backing Store</div>
            <div className="text-center">
              <div className="border-4 border-emerald-500 bg-emerald-50 px-4 py-2 md:px-6 md:py-3 rounded-2xl font-bold text-gray-800 text-sm md:text-base">Process P2</div>
              <p className="text-xs md:text-sm text-gray-600 mt-2">↑ Loaded Into RAM</p>
            </div>
          </div>
        </div>
        ...
        <Quiz
          title="Module 4.1 Quiz: Memory Management Intro"
          questions={memoryIntroQuiz}
          subject="OS"
          unitId={4}
          moduleId={1}
        />
