      ...
      <div className="flex justify-center gap-4">
        {[1, 2, 3].map(disk => (
          <div key={disk} className="flex flex-col items-center">
            <div className={`w-24 h-32 flex items-center justify-center rounded-lg font-bold text-white transition-all ${step === disk - 1 ? 'bg-blue-600 scale-110' : 'bg-blue-400'
              }`}>
              Disk {disk}
            </div>
    ...
    <div className="border-4 border-red-500 bg-red-50 p-6 rounded-lg">
      ...
      <div className="flex justify-center gap-4">
        <div className="flex flex-col gap-2">
          ...
          <div className={`w-16 h-16 flex items-center justify-center rounded font-bold text-white ${block === 0 ? 'bg-red-600' : 'bg-red-400'
            }`}>A</div>
          <div className={`w-16 h-16 flex items-center justify-center rounded font-bold text-white ${block === 2 ? 'bg-red-600' : 'bg-red-400'
            }`}>C</div>
        </div>
        <div className="flex flex-col gap-2">
          <div className="text-center font-semibold text-sm">Disk 2</div>
          <div className={`w-16 h-16 flex items-center justify-center rounded font-bold text-white ${block === 1 ? 'bg-red-600' : 'bg-red-400'
            }`}>B</div>
          <div className={`w-16 h-16 flex items-center justify-center rounded font-bold text-white ${block === 3 ? 'bg-red-600' : 'bg-red-400'
            }`}>D</div>
        </div>
      </div>
  ...
  return (
    <div className="border-4 border-green-500 bg-green-50 p-6 rounded-lg">
      ...
      <div className="flex justify-center gap-4">
        <div className="flex flex-col gap-2">
          <div className="text-center font-semibold text-sm">Disk 1</div>
          <div className={`w-16 h-16 flex items-center justify-center rounded font-bold text-white ${active === 0 ? 'bg-green-600' : 'bg-green-400'
            }`}>A</div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className={`w-16 h-16 flex items-center justify-center rounded font-bold text-white ${active === 1 ? 'bg-green-600' : 'bg-green-400'
            }`}>A</div>
          <div className="w-16 h-16 flex items-center justify-center rounded font-bold text-white bg-green-400">B</div>
        </div>
      </div>
      ...
      <div className="flex justify-center gap-4">
        {[1, 2, 3].map(disk => (
          <div key={disk} className="flex flex-col gap-2">
            ...
            <div className={`w-16 h-16 flex items-center justify-center rounded font-bold text-white ${active === disk - 1 ? 'bg-purple-600' : 'bg-purple-400'
              }`}>
              {disk === 1 ? 'A' : disk === 2 ? 'B' : 'P'}
            </div>
          </div>
  ...
  return (
    <div className="module-content">
      ...
      <section className="content-section">
        ...
        <Quiz
          title="Module 5.5 Quiz: RAID"
          questions={[
            {
              question: "What does RAID stand for?",
              options: ["Random Array of Independent Disks", "Redundant Array of Independent Disks", "Regular Array of Individual Disks", "Redundant Array of Information Devices"],
              correctAnswer: 1,
              explanation: "RAID stands for Redundant Array of Independent Disks, a technology used to combine multiple disks into a single unit for better performance and/or redundancy."
            },
            {
              question: "Which RAID level uses 'mirroring' to provide fault tolerance?",
              options: ["RAID 0", "RAID 1", "RAID 5", "RAID 10"],
              correctAnswer: 1,
              explanation: "RAID 1 uses mirroring to create an exact copy of data on two or more disks."
            },
            {
              question: "RAID 0 is primarily used for:",
              options: ["Fault tolerance", "Data protection", "Performance (Speed)", "Archiving"],
              correctAnswer: 2,
              explanation: "RAID 0 (striping) spreads data across multiple disks to increase performance but provides no fault tolerance."
            },
            {
              question: "How many drives can fail in RAID 6 without losing data?",
              options: ["0", "1", "2", "3"],
              correctAnswer: 2,
              explanation: "RAID 6 uses dual parity, allowing up to two drive failures without data loss."
            },
            {
              question: "Which RAID level requires at least 3 disks and uses parity information?",
              options: ["RAID 1", "RAID 5", "RAID 6", "RAID 10"],
              correctAnswer: 1,
              explanation: "RAID 5 requires at least 3 disks and uses distributed parity to allow for a single drive failure recovery."
            }
          ]}
          subject="OS"
          unitId={5}
