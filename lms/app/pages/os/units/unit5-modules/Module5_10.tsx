  ...
  return (
    <div className="module-content">
      ...
      <section className="content-section">
        ...
        <Quiz
          title="Module 5.10 Quiz: Linux Directories"
          questions={[
            {
              question: "What does the '/' symbol represent in the Linux filesystem?",
              options: ["The current user folder", "The root directory", "The desktop", "A shortcut to documents"],
              correctAnswer: 1,
              explanation: "The forward slash / is the root directory, the top-level directory from which all other files and folders branch out."
            },
            {
              question: "If you are in '/home/user/Documents' and you type 'cd ..', where will you be?",
              options: ["/home", "/home/user", "/root", "/home/user/Downloads"],
              correctAnswer: 1,
            ...
            },
            {
              ...
              options: ["Absolute paths are shorter", "Relative paths always start with /", "Absolute paths start from /, while relative paths start from the current directory", "Relative paths are for files only"],
              correctAnswer: 2,
              explanation: "An absolute path is the full path starting from root, whereas a relative path is defined based on where you currently are."
            },
            {
              question: "Which command is used to remove a directory that is NOT empty?",
              options: ["rmdir", "delete", "rm -r", "erase"],
              correctAnswer: 2,
              explanation: "rmdir only works on empty directories. rm -r (recursive) is needed to delete a directory and all its contents."
            },
            {
              question: "In Linux, what does the '~' (tilde) shortcut represent?",
              options: ["The current directory", "The parent directory", "The current user's home directory", "The root directory"],
              correctAnswer: 2,
              explanation: "The tilde ~ is a shortcut for the home directory of the currently logged-in user."
            }
          ]}
          subject="OS"
          unitId={5}
