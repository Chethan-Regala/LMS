                ...
                <main className="flex-1 sm:ml-[280px] px-6 sm:px-16 py-6 sm:py-10 w-full relative z-10">
                    ...
                    <div className="flex items-center justify-between mb-8 sm:mb-12">
                        <div className="flex items-center gap-4">
                            ...
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-[#1E3A8A]">Personnel Registry</h2>
                        </div>
                    ...
                    <div className="mb-12 px-2">
                        ...
                        <p className="text-slate-500 font-semibold text-sm sm:text-lg max-w-2xl leading-relaxed">
                            Provision new accounts, maintain credentials, and monitor institutional access levels.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                        ...
                        <div className="bg-white border border-[#E5E2D9] rounded-[2rem] p-8 shadow-sm hover:border-[#3E73C1]/30 transition-all group">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h3 className="text-lg font-bold text-[#1E3A8A] tracking-tight uppercase">Provision Student</h3>
                            </div>
                        ...
                        <div className="bg-white border border-[#E5E2D9] rounded-[2rem] p-8 shadow-sm hover:border-[#3E73C1]/30 transition-all group">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h3 className="text-lg font-bold text-[#1E3A8A] tracking-tight uppercase">Elevate Administrator</h3>
                            </div>
                            <div className="flex flex-col sm:flex-row gap-4">
                                <div className="relative flex-1">
                                    <input
                                        type="email"
                                        placeholder="admin.id@system.root"
                                        value={newAdminEmail}
                    ...
                    <div className="bg-white border border-[#E5E2D9] rounded-[2.5rem] p-8 shadow-sm">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-10">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-xl font-bold text-[#121212] tracking-tight uppercase">Active Registry</h3>
                            </div>
                            <div className="relative max-w-md w-full">
                                <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400" />
                                <input
                                    type="text"
                                    placeholder="Filter by identifier or name..."
                                    value={searchQuery}
                                ...
                                <div key={user._id} className="group relative bg-[#F8F6F1]/50 border border-[#E5E2D9] rounded-[2rem] p-6 hover:bg-white hover:border-[#3E73C1]/30 transition-all duration-300">
                                    <div className="flex justify-between items-start mb-4">
                                        <div className="flex-1 min-w-0">
                                            <h4 className="font-bold text-base text-[#121212] truncate tracking-tight">{user.fullName || "Uninitialized"}</h4>
                    ...
                    <div className="fixed inset-0 flex items-center justify-center z-[100] p-4">
                        ...
                        >
                            <div className="flex items-center justify-between mb-8">
                                <div>
                                    <h2 className="text-2xl font-bold text-[#1E3A8A] tracking-tighter uppercase mb-1">Update Protocol</h2>
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Applying changes to {editUser.email}</p>
                                </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Communication Link (Phone)</label>
                                    <input
                                        type="text"
                                ...
                                {!editUser.isAdmin && (
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Academic Stratum (Semester)</label>
