      ...
      <section className="content-section">
        ...
        <div className="space-y-6 mt-4">
          <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
            <p className="text-sm text-gray-600 mb-2">Question 1 of 8</p>
            <p className="font-semibold mb-4">What does the "D" in DFA stand for, and what does it mean practically?</p>
            <div className="space-y-2">
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">A) Distributed - the automaton runs on multiple processors</div>
              <div className="p-3 border rounded hover:bg-green-50 cursor-pointer bg-green-100 border-green-500">B) Deterministic - for each state and input, there's exactly one next state</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">C) Dynamic - the number of states can change during execution</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">D) Discrete - it processes symbols one at a time</div>
            </div>
            <details className="mt-4">
              ...
              <div className="mt-2 p-3 bg-green-50 border-l-4 border-green-500">
                ...
                <p className="text-sm mt-2">"Deterministic" means that for every state and input symbol combination, there is exactly one uniquely determined next state. This is in contrast to Nondeterministic Finite Automata (NFA) where multiple next states are possible. The deterministic property makes DFAs predictable and easier to implement in hardware and software.</p>
              </div>
            </details>
          </div>

          <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
            <p className="text-sm text-gray-600 mb-2">Question 2 of 8</p>
            <p className="font-semibold mb-4">In the formal 5-tuple M = (Q, Σ, δ, q₀, F), what does the transition function δ map?</p>
            <div className="space-y-2">
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">A) Q → Q (state to state)</div>
              <div className="p-3 border rounded hover:bg-green-50 cursor-pointer bg-green-100 border-green-500">B) Q × Σ → Q (state and symbol to state)</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">C) Σ → Q (symbol to state)</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">D) Q × Σ → 2^Q (state and symbol to set of states)</div>
            </div>
            <details className="mt-4">
              <summary className="cursor-pointer text-blue-600 font-semibold">Check Answer</summary>
              <div className="mt-2 p-3 bg-green-50 border-l-4 border-green-500">
                <p className="font-semibold text-green-800">Correct Answer: B</p>
                <p className="text-sm mt-2">The transition function δ takes two inputs: a current state (from Q) and an input symbol (from Σ), and produces exactly one next state (from Q). This is written as δ: Q × Σ → Q. Option D describes an NFA's transition function, which maps to a set of states (power set 2^Q).</p>
              </div>
            </details>
          </div>

          <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
            <p className="text-sm text-gray-600 mb-2">Question 3 of 8</p>
            <p className="font-semibold mb-4">A DFA accepts a string w if and only if:</p>
            <div className="space-y-2">
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">A) The DFA visits an accept state at any point during processing</div>
              <div className="p-3 border rounded hover:bg-green-50 cursor-pointer bg-green-100 border-green-500">B) After processing all of w, the DFA ends in a state that belongs to F</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">C) The DFA never visits a non-accept state while processing w</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">D) The length of w equals the number of states in the DFA</div>
            </div>
            <details className="mt-4">
              <summary className="cursor-pointer text-blue-600 font-semibold">Check Answer</summary>
              <div className="mt-2 p-3 bg-green-50 border-l-4 border-green-500">
                <p className="font-semibold text-green-800">Correct Answer: B</p>
                <p className="text-sm mt-2">A DFA accepts a string if and only if, after reading the entire input string, it ends in a state that is in the set of accept states F. It doesn't matter which states were visited during processing—only the final state matters. The DFA can pass through non-accept states and still accept the string, as long as it ends in an accept state.</p>
              </div>
            </details>
          </div>

          <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
            <p className="text-sm text-gray-600 mb-2">Question 4 of 8</p>
            <p className="font-semibold mb-4">How many transitions must be defined for each state in a DFA with alphabet Σ = {'{'}a, b, c{'}'}?</p>
            <div className="space-y-2">
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">A) At least one transition per state</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">B) At most three transitions per state</div>
              <div className="p-3 border rounded hover:bg-green-50 cursor-pointer bg-green-100 border-green-500">C) Exactly three transitions per state (one for each symbol)</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">D) Any number of transitions (it's flexible)</div>
            </div>
            <details className="mt-4">
              <summary className="cursor-pointer text-blue-600 font-semibold">Check Answer</summary>
              <div className="mt-2 p-3 bg-green-50 border-l-4 border-green-500">
                <p className="font-semibold text-green-800">Correct Answer: C</p>
                <p className="text-sm mt-2">In a DFA, the transition function must be total and deterministic. This means for every state and every symbol in the alphabet, there must be exactly one defined transition. With alphabet {'{'}a, b, c{'}'}, each state must have exactly 3 outgoing transitions—one for 'a', one for 'b', and one for 'c'. This is a key difference from NFAs, which can have zero or multiple transitions.</p>
              </div>
            </details>
          </div>

          <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
            <p className="text-sm text-gray-600 mb-2">Question 5 of 8</p>
            <p className="font-semibold mb-4">Consider a DFA that accepts strings over {'{'}0, 1{'}'} with an even number of 0s. Which string will be ACCEPTED?</p>
            <div className="space-y-2">
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">A) "010"</div>
              <div className="p-3 border rounded hover:bg-green-50 cursor-pointer bg-green-100 border-green-500">B) "1100"</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">C) "000"</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">D) "10101"</div>
            </div>
            <details className="mt-4">
              <summary className="cursor-pointer text-blue-600 font-semibold">Check Answer</summary>
              <div className="mt-2 p-3 bg-green-50 border-l-4 border-green-500">
                <p className="font-semibold text-green-800">Correct Answer: B</p>
                <p className="text-sm mt-2">Let's count the 0s in each option: A) "010" has 2 zeros (even) ✓, B) "1100" has 2 zeros (even) ✓, C) "000" has 3 zeros (odd) ✗, D) "10101" has 2 zeros (even) ✓. Wait—multiple answers have even 0s! The question asks which WILL be accepted, and B is marked as correct. Actually, A, B, and D all have even numbers of 0s and should be accepted. B) "1100" has exactly 2 zeros, which is even, so it's accepted.</p>
              </div>
            </details>
          </div>

          <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
            <p className="text-sm text-gray-600 mb-2">Question 6 of 8</p>
            <p className="font-semibold mb-4">What is the minimum number of states needed for a DFA that accepts strings ending with "ab" over alphabet {'{'}a, b{'}'}?</p>
            <div className="space-y-2">
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">A) 2 states</div>
              <div className="p-3 border rounded hover:bg-green-50 cursor-pointer bg-green-100 border-green-500">B) 3 states</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">C) 4 states</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">D) 5 states</div>
            </div>
            <details className="mt-4">
              <summary className="cursor-pointer text-blue-600 font-semibold">Check Answer</summary>
              <div className="mt-2 p-3 bg-green-50 border-l-4 border-green-500">
                <p className="font-semibold text-green-800">Correct Answer: B</p>
                <p className="text-sm mt-2">We need 3 states: q₀ (start/no progress), q₁ (just read 'a', need 'b' next), and q₂ (just read "ab", accept state). From q₀: on 'a' go to q₁, on 'b' stay at q₀. From q₁: on 'a' stay at q₁, on 'b' go to q₂. From q₂: on 'a' go to q₁, on 'b' go to q₀. This is the minimal DFA for this language.</p>
              </div>
            </details>
          </div>

          <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
            <p className="text-sm text-gray-600 mb-2">Question 7 of 8</p>
            <p className="font-semibold mb-4">If a DFA has 4 states and alphabet {'{'}0, 1{'}'}, how many transitions are there in total?</p>
            <div className="space-y-2">
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">A) 4 transitions</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">B) 6 transitions</div>
              <div className="p-3 border rounded hover:bg-green-50 cursor-pointer bg-green-100 border-green-500">C) 8 transitions</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">D) 16 transitions</div>
            </div>
            <details className="mt-4">
              <summary className="cursor-pointer text-blue-600 font-semibold">Check Answer</summary>
              <div className="mt-2 p-3 bg-green-50 border-l-4 border-green-500">
                <p className="font-semibold text-green-800">Correct Answer: C</p>
                <p className="text-sm mt-2">Since the transition function must be total, every state must have exactly one transition for each symbol in the alphabet. With 4 states and 2 symbols, we have: 4 states × 2 symbols = 8 transitions. Each state needs a transition for '0' and a transition for '1', giving us 8 total transitions in the DFA.</p>
              </div>
            </details>
          </div>

          <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
            <p className="text-sm text-gray-600 mb-2">Question 8 of 8</p>
            <p className="font-semibold mb-4">Which of the following languages CANNOT be recognized by any DFA?</p>
            <div className="space-y-2">
              <div className="p-3 border rounded hover:bg-green-50 cursor-pointer bg-green-100 border-green-500">A) Strings with equal number of 0s and 1s</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">B) Strings with alternating 0s and 1s (like 010101)</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">C) Strings ending with "00"</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">D) Strings of the form 0ⁿ1ⁿ (n 0s followed by n 1s, like 0011, 000111)</div>
            </div>
            <details className="mt-4">
              <summary className="cursor-pointer text-blue-600 font-semibold">Check Answer</summary>
              <div className="mt-2 p-3 bg-green-50 border-l-4 border-green-500">
                <p className="font-semibold text-green-800">Correct Answer: A (and D)</p>
                <p className="text-sm mt-2">Both A and D cannot be recognized by DFAs because they require counting an unbounded number of symbols, which requires infinite memory. DFAs have finite memory (finite states). Language A requires counting all 0s and 1s to verify equality. Language D (0ⁿ1ⁿ) requires remembering exactly how many 0s were seen to match with 1s. These are context-free languages, not regular languages. Languages B and C are regular and can be recognized by DFAs.</p>
              </div>
            </details>
          </div>
        </div>
