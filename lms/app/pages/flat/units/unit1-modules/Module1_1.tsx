...
const Module1_1: React.FC = () => {
  const quizQuestions = [
    {
      question: "Which proof technique assumes the negation of the conclusion to derive an impossibility?",
      options: ["Direct Proof", "Proof by Contrapositive", "Proof by Contradiction", "Mathematical Induction"],
      correctAnswer: 2,
      explanation: "Proof by contradiction (Reductio ad Absurdum) starts by assuming the statement is false and shows this leads to a logical impossibility."
    },
    {
      question: "The principle of mathematical induction is based on which property of natural numbers?",
      options: ["Archimedean Property", "Well-ordering Principle", "Density Property", "Completeness Axiom"],
      correctAnswer: 1,
      explanation: "The well-ordering principle states that every non-empty set of natural numbers has a least element, which ensures induction reaches every number."
    },
    {
      question: "Which inference rule allows deriving Q from P and P → Q?",
      options: ["Modus Tollens", "Hypothetical Syllogism", "Modus Ponens", "Disjunctive Syllogism"],
      correctAnswer: 2,
      explanation: "Modus Ponens (the mode of affirming) is the rule: from the truth of P and the implication P → Q, we conclude Q."
    },
    {
      question: "Proof by contrapositive is based on the logical equivalence between P → Q and:",
      options: ["Q → P", "¬P → ¬Q", "¬Q → ¬P", "P ∨ Q"],
      correctAnswer: 2,
      explanation: "An implication is logically equivalent to its contrapositive: (P → Q) ≡ (¬Q → ¬P)."
    },
    {
      question: "Structural induction is primarily used for proving properties of:",
      options: ["Finite sets", "Continuous functions", "Recursively defined structures", "Real numbers"],
      correctAnswer: 2,
      explanation: "Structural induction is an extension of induction used to prove properties about objects like trees, expressions, and languages defined recursively."
    }
  ];
  return (
...
if __name__ == "__main__":
    sum_formula_example()`}
      ...
      {/* Module Quiz */}
      <section className="content-section">
        <h2 className="text-2xl font-bold mb-6">Module 1.1 Mastery Quiz</h2>
