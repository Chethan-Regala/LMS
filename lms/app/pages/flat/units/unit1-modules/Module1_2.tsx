...
const Module1_2: React.FC = () => {
  const quizQuestions = [
    {
      question: "You want to prove: \"If a language L is recognized by a DFA with n states, then L is regular.\" Which proof technique is most appropriate?",
      options: ["Proof by contradiction", "Proof by contrapositive", "Direct proof (using definition)", "Proof by counterexample"],
      correctAnswer: 2,
      explanation: "This is a straightforward application of the definition of regular languages. By definition, a language is regular if and only if it is recognized by some DFA. Since we're given that L is recognized by a DFA with n states, we can directly conclude that L is regular. This is a direct proof using the definition—no need for contradiction, contrapositive, or counterexample."
    },
    {
      question: "Which of the following is the contrapositive of \"If a language L is regular, then L has a pumping length p\"?",
      options: ["If L has a pumping length p, then L is regular (converse)", "If L does not have a pumping length p, then L is not regular", "If L is not regular, then L does not have a pumping length p", "If L is regular, then L does not have a pumping length p"],
      correctAnswer: 1,
      explanation: "The contrapositive of \"If P then Q\" is \"If not Q then not P.\" Here, P = \"L is regular\" and Q = \"L has a pumping length p.\" So the contrapositive is: \"If L does not have a pumping length p, then L is not regular.\" Note that option A is the converse (which is NOT logically equivalent), and option C reverses the negations incorrectly. The contrapositive is always logically equivalent to the original statement."
    },
    {
      question: "You want to disprove the claim: \"All context-free languages are regular.\" What is the most efficient approach?",
      options: ["Proof by contradiction", "Proof by counterexample", "Proof by construction", "Proof by contrapositive"],
      correctAnswer: 1,
      explanation: "To disprove a universal claim (\"All X are Y\"), the most efficient approach is to find a single counterexample. We need just one context-free language that is not regular. For example, L = {0ⁿ1ⁿ | n ≥ 0} is context-free (can be recognized by a PDA) but not regular (fails the pumping lemma). This single counterexample disproves the entire claim. Contradiction or contrapositive would be unnecessarily complex for disproving a universal statement."
    },
    {
      question: "To prove \"There exists a DFA with 3 states that recognizes the language L = {w | w has an even number of 1s}\", which proof technique should you use?",
      options: ["Proof by contradiction", "Proof by construction", "Proof by contrapositive", "Mathematical induction"],
      correctAnswer: 1,
      explanation: "This is an existence claim (\"There exists...\"), which is best proven by construction. We explicitly construct a DFA with 3 states: q₀ (start, even count, accepting), q₁ (odd count, non-accepting), and q₂ (trap/dead state if needed, though actually 2 states suffice). We define transitions: from q₀, on '1' go to q₁, on '0' stay at q₀; from q₁, on '1' go to q₀, on '0' stay at q₁. By constructing this specific DFA and verifying it works, we prove existence. Contradiction would be indirect and unnecessary here."
    },
    {
      question: "Consider the statement: \"If a DFA M has n states, then M recognizes infinitely many strings or recognizes finitely many strings.\" Which statement is true about this?",
      options: ["This requires proof by contradiction because it involves infinity", "This is false and can be disproven with a counterexample", "This is a tautology (always true) and requires no proof", "This requires proof by construction to build examples of both cases"],
      correctAnswer: 2,
      explanation: "This statement is a tautology—it's true by the law of excluded middle. For any DFA M, the language L(M) it recognizes is either finite or infinite; there's no third option. The statement \"P or not P\" (in this case, \"infinitely many or finitely many\") is always true regardless of the specific DFA. This is a logical truth that requires no proof. It's like saying \"Either it's raining or it's not raining\"—trivially true by definition of logical disjunction."
    }
  ];
