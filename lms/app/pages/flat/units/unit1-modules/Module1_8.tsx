...
if __name__ == '__main__':
    ...
    nfa.accepts('abc', verbose=True)`}
      ...
      <section style={{ marginBottom: '48px' }}>
        ...
        {/* Q1 */}
        <div style={{ backgroundColor: '#f9fafb', border: '2px solid #d1d5db', borderRadius: '8px', padding: '24px', marginBottom: '20px' }}>
          <h3 style={{ fontSize: '1.125rem', fontWeight: '700', color: '#1f2937', marginBottom: '16px' }}>Q1. What is the ε-closure of a state q if there are no ε-transitions from q?</h3>
          <div style={{ display: 'grid', gap: '12px', marginBottom: '16px' }}>
            {[
              { id: 'q1a', text: 'The empty set ∅', correct: false },
              { id: 'q1b', text: '{q} — only q itself', correct: true },
              { id: 'q1c', text: 'The set of all states Q', correct: false },
              { id: 'q1d', text: 'Undefined — ε-closure requires at least one ε-transition', correct: false }
            ].map(option => (
          ...
          {mcqAnswers.q1 && (
            <div style={{ marginTop: '16px', padding: '16px', backgroundColor: '#dcfce7', border: '2px solid #10b981', borderRadius: '6px' }}>
              <div style={{ fontWeight: '700', color: '#065f46', marginBottom: '8px' }}>✅ Correct Answer: {'{q}'} — only q itself</div>
              <p style={{ margin: 0, fontSize: '0.95rem', color: '#047857' }}>By definition, ε-closure(q) includes q itself (zero ε-transitions) plus all states reachable via ε-transitions. If there are no ε-transitions from q, then ε-closure(q) = {'{q}'}.</p>
            </div>
          )}
        </div>
        ...
        {/* Q2 */}
        <div style={{ backgroundColor: '#f9fafb', border: '2px solid #d1d5db', borderRadius: '8px', padding: '24px', marginBottom: '20px' }}>
          <h3 style={{ fontSize: '1.125rem', fontWeight: '700', color: '#1f2937', marginBottom: '16px' }}>Q2. An ε-NFA has ε-transitions q0→q1, q1→q2. What is ε-closure({'{q0}'})?</h3>
          <div style={{ display: 'grid', gap: '12px', marginBottom: '16px' }}>
            {[
              { id: 'q2a', text: '{q0}', correct: false },
              { id: 'q2b', text: '{q0, q1}', correct: false },
              { id: 'q2c', text: '{q0, q1, q2}', correct: true },
              { id: 'q2d', text: '{q1, q2}', correct: false }
            ].map(option => (
              <label key={option.id} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px', backgroundColor: 'white', borderRadius: '6px', cursor: 'pointer', border: '2px solid #e5e7eb' }}>
          ...
          {mcqAnswers.q2 && (
            <div style={{ marginTop: '16px', padding: '16px', backgroundColor: '#dcfce7', border: '2px solid #10b981', borderRadius: '6px' }}>
              <div style={{ fontWeight: '700', color: '#065f46', marginBottom: '8px' }}>✅ Correct Answer: {'{q0, q1, q2}'}</div>
              <p style={{ margin: 0, fontSize: '0.95rem', color: '#047857' }}>Start with q0. Follow ε to q1. From q1, follow ε to q2. The ε-closure is transitive, so all three states are included.</p>
            </div>
          )}
        </div>
        ...
        {/* Q3 */}
        <div style={{ backgroundColor: '#f9fafb', border: '2px solid #d1d5db', borderRadius: '8px', padding: '24px', marginBottom: '20px' }}>
          <h3 style={{ fontSize: '1.125rem', fontWeight: '700', color: '#1f2937', marginBottom: '16px' }}>Q3. Which of the following correctly describes the relationship between DFA, NFA, and ε-NFA?</h3>
          <div style={{ display: 'grid', gap: '12px', marginBottom: '16px' }}>
            {[
              { id: 'q3a', text: 'ε-NFA is strictly more powerful than DFA and NFA', correct: false },
              { id: 'q3b', text: 'DFA is strictly more powerful than NFA, which is more powerful than ε-NFA', correct: false },
              { id: 'q3c', text: 'All three accept exactly the same class of languages (regular languages)', correct: true },
              { id: 'q3d', text: 'ε-NFA can recognize some context-free languages that DFA cannot', correct: false }
            ].map(option => (
              <label key={option.id} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px', backgroundColor: 'white', borderRadius: '6px', cursor: 'pointer', border: '2px solid #e5e7eb' }}>
          ...
          {mcqAnswers.q3 && (
            <div style={{ marginTop: '16px', padding: '16px', backgroundColor: '#dcfce7', border: '2px solid #10b981', borderRadius: '6px' }}>
              <div style={{ fontWeight: '700', color: '#065f46', marginBottom: '8px' }}>✅ Correct Answer: All three accept exactly the same class of languages (regular languages)</div>
              <p style={{ margin: 0, fontSize: '0.95rem', color: '#047857' }}>This is Kleene's theorem: DFA, NFA, and ε-NFA are all equivalent in computational power. They all recognize exactly the regular languages. ε-transitions add convenience, not power.</p>
            </div>
          )}
        </div>
        ...
        {/* Q4 */}
        <div style={{ backgroundColor: '#f9fafb', border: '2px solid #d1d5db', borderRadius: '8px', padding: '24px', marginBottom: '20px' }}>
          <h3 style={{ fontSize: '1.125rem', fontWeight: '700', color: '#1f2937', marginBottom: '16px' }}>Q4. In the conversion of an ε-NFA to a DFA, the DFA's start state is:</h3>
          <div style={{ display: 'grid', gap: '12px', marginBottom: '16px' }}>
            {[
              { id: 'q4a', text: 'The same as the ε-NFA\'s start state', correct: false },
              { id: 'q4b', text: 'The ε-closure of the ε-NFA\'s start state', correct: true },
              { id: 'q4c', text: 'The set of all states reachable from the start state on any input', correct: false },
              { id: 'q4d', text: 'A newly created state with transitions to the ε-NFA\'s start state', correct: false }
            ].map(option => (
              <label key={option.id} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px', backgroundColor: 'white', borderRadius: '6px', cursor: 'pointer', border: '2px solid #e5e7eb' }}>
          ...
          {mcqAnswers.q4 && (
            <div style={{ marginTop: '16px', padding: '16px', backgroundColor: '#dcfce7', border: '2px solid #10b981', borderRadius: '6px' }}>
              <div style={{ fontWeight: '700', color: '#065f46', marginBottom: '8px' }}>✅ Correct Answer: The ε-closure of the ε-NFA's start state</div>
              <p style={{ margin: 0, fontSize: '0.95rem', color: '#047857' }}>In subset construction, the DFA start state is q₀' = ε-closure({'{q₀}'}). This accounts for all states reachable via ε-transitions from the start state before reading any input.</p>
            </div>
          )}
        </div>
        ...
        {/* Q5 */}
        <div style={{ backgroundColor: '#f9fafb', border: '2px solid #d1d5db', borderRadius: '8px', padding: '24px', marginBottom: '20px' }}>
          <h3 style={{ fontSize: '1.125rem', fontWeight: '700', color: '#1f2937', marginBottom: '16px' }}>Q5. Thompson's construction converts a regular expression with n symbols into an ε-NFA with at most how many states?</h3>
          <div style={{ display: 'grid', gap: '12px', marginBottom: '16px' }}>
            {[
              { id: 'q5a', text: 'n states', correct: false },
              { id: 'q5b', text: 'n + 1 states', correct: false },
              { id: 'q5c', text: '2n states', correct: true },
              { id: 'q5d', text: '2ⁿ states', correct: false }
            ].map(option => (
              <label key={option.id} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px', backgroundColor: 'white', borderRadius: '6px', cursor: 'pointer', border: '2px solid #e5e7eb' }}>
          ...
          {mcqAnswers.q5 && (
            <div style={{ marginTop: '16px', padding: '16px', backgroundColor: '#dcfce7', border: '2px solid #10b981', borderRadius: '6px' }}>
              <div style={{ fontWeight: '700', color: '#065f46', marginBottom: '8px' }}>✅ Correct Answer: 2n states</div>
              <p style={{ margin: 0, fontSize: '0.95rem', color: '#047857' }}>Thompson's construction creates at most 2 states per symbol/operator in the regex. For a regex with n symbols, the resulting ε-NFA has at most 2n states. This is a linear bound, making Thompson's construction very efficient.</p>
            </div>
          )}
        </div>
      </section>
