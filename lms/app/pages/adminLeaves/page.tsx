                ...
                <main className="flex-1 sm:ml-[280px] px-6 sm:px-16 py-6 sm:py-10 w-full relative z-10">
                    ...
                    <div className="flex items-center justify-between mb-8 sm:mb-12">
                        <div className="flex items-center gap-4">
                            ...
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-[#1E3A8A]">Approval System</h2>
                        </div>
                        <div className="flex items-center gap-3">
                            <div className="flex flex-col items-end">
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                    ...
                                    <p className="text-sm font-bold text-[#3E73C1]">Live Protocols</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-12 px-2">
                        ...
                        <p className="text-slate-500 font-semibold text-sm sm:text-lg max-w-2xl leading-relaxed">
                            Review and process institutional absence requests. All actions are logged to the permanent record.
                        </p>
                    </div>
                    ...
                    <div className="bg-white border border-[#E5E2D9] rounded-[2.5rem] p-8 shadow-sm min-h-[500px]">
                        <div className="flex items-center gap-3 mb-10">
                            ...
                            <h3 className="text-xl font-bold text-[#121212] tracking-tight uppercase">Incoming Requests</h3>
                        </div>

                        {leaves.length === 0 ? (
                            <div className="flex flex-col items-center justify-center py-24 opacity-40">
                                <AlertCircle className="w-16 h-16 mb-4 text-slate-300" />
                                <p className="text-slate-400 font-bold text-xl uppercase tracking-widest">No active requests</p>
                            </div>
                        ) : (
                                    ...
                                    >
                                        ...
                                        <div className="bg-white p-5 rounded-2xl border border-[#E5E2D9]/50 mb-6 relative overflow-hidden">
                                            ...
                                            <div className="flex items-center gap-2 text-[9px] font-bold uppercase tracking-widest text-slate-400">
                                                ...
                                                Logged: {new Date(leave.createdAt).toLocaleString()}
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            >
                                                ...
                                                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-rose-600 group-hover/del:text-white">Relinquish Entry</span>
                                            </button>
                                        </div>
                                    </motion.div>
                                ))}
