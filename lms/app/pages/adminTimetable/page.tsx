                ...
                <main className="flex-1 sm:ml-[280px] px-6 sm:px-16 py-6 sm:py-10 w-full relative z-10">
                    ...
                    <div className="flex items-center justify-between mb-8 sm:mb-12">
                        <div className="flex items-center gap-4">
                            ...
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-[#1E3A8A]">Temporal Grid</h2>
                        </div>
                        <div className="flex items-center gap-3">
                            <div className="flex flex-col items-end">
                                <p className="text-[10px] font-bold uppercase text-[#888] tracking-widest leading-none">Status</p>
                                <p className="text-sm font-bold text-[#3E73C1] mt-1">Operational v2.1</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-12 px-2">
                        ...
                        <p className="text-slate-500 font-semibold text-sm sm:text-lg max-w-2xl leading-relaxed">
                            Orchestrating institutional time-blocks and professor allocation. All changes synchronize across student terminals.
                        </p>
                    </div>
                    ...
                    <div className="bg-white border border-[#E5E2D9] rounded-[2.5rem] p-8 shadow-sm mb-12 overflow-hidden">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <h3 className="text-xl font-bold text-[#121212] tracking-tight uppercase">Curriculum Matrix</h3>
                        </div>
                            ...
                            <table className="w-full min-w-[1000px] border-collapse">
                                <thead>
                                    <tr className="bg-[#F8F6F1]">
                                        <th className="p-6 text-left font-bold text-[10px] uppercase tracking-[0.2em] text-[#3E73C1] border-b border-r border-[#E5E2D9] w-32">Temporal Point</th>
                                    ...
                                    <div className="space-y-4 mb-8">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs font-bold text-[#121212]">{subjectData?.teacher || "Awaiting Allocation"}</p>
                                            </div>
                                        </div>
                                        <div className="bg-[#F8F6F1]/50 p-4 rounded-2xl border border-[#E5E2D9]/50 min-h-[80px]">
                                            <p className="text-[10px] font-bold uppercase tracking-widest text-[#3E73C1] mb-2">Contextual Data</p>
                            ...
                            <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-center mb-10">
                                        <div>
                                            <p className="text-[10px] font-bold uppercase text-[#3E73C1] tracking-[0.2em] mb-2 leading-none">Record refinement</p>
                                    ...
                                    <div className="space-y-8">
                                        <div className="space-y-3">
                                            <label className="text-[11px] font-bold uppercase tracking-widest text-[#1E3A8A] ml-1">Professor Designation</label>
                                            <input
                                                type="text"
                                        ...
                                        <div className="space-y-3">
                                            <label className="text-[11px] font-bold uppercase tracking-widest text-[#1E3A8A] ml-1">Curriculum description</label>
                                            <textarea
                                                placeholder="Provide contextual information..."
