                ...
                <main className="flex-1 sm:ml-[280px] px-6 sm:px-16 py-6 sm:py-10 w-full relative z-10">
                    ...
                    <div className="flex items-center justify-between mb-8 sm:mb-12">
                        <div className="flex items-center gap-4">
                            ...
                            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-[#1E3A8A]">Intelligence Receiver</h2>
                        </div>
                        <div className="flex items-center gap-3">
                            <div className="flex items-center gap-2 bg-emerald-50 px-4 py-2 rounded-2xl border border-emerald-100">
                                <ShieldCheck className="w-4 h-4 text-emerald-600" />
                                <span className="text-[10px] font-bold uppercase text-emerald-600 tracking-widest">Secure Link</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-12 px-2">
                        ...
                        <p className="text-slate-500 font-semibold text-sm sm:text-lg max-w-2xl leading-relaxed">
                            Anonymous intelligence pipeline. Decrypted submissions are stored temporarily before automated purging.
                        </p>
                    </div>
                    ...
                    <div className="bg-white border border-[#E5E2D9] rounded-[2.5rem] p-8 sm:p-10 shadow-sm min-h-[500px]">
                        <div className="flex items-center justify-between mb-10">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-xl font-bold text-[#121212] tracking-tight uppercase">Incoming Signal</h3>
                            </div>
                        ...
                        {feedback.length === 0 ? (
                            <div className="flex flex-col items-center justify-center py-24 opacity-40">
                                ...
                                <p className="text-slate-400 font-bold text-xl uppercase tracking-widest">Frequency Silent</p>
                            </div>
                        ) : (
                                        ...
                                        <div className="pt-6 border-t border-[#E5E2D9]/50 flex items-center justify-between">
                                            <div className="flex items-center gap-2 group/alert">
                                                ...
                                                <p className="text-[8px] font-bold uppercase tracking-widest text-slate-400 group-hover/alert:text-rose-500 transition-colors">
                                                    Self-Destruct: {new Date(item.expiresAt).toLocaleDateString()}
                                                </p>
                                            </div>
                                        </div>
                                    </motion.div>
